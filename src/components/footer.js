        ...
        <div className="footer-bottom-container">
          <div className="footer-left-side">
            ...
            <div className="footer-social-media">
              <span className="footer-text07">Follow Energy-zoids</span>
          ...
          <div className="footer-links">
            ...
            <div className="footer-container2">
              ...
              <span className="footer-link">connect on instagram</span>
              <span className="footer-link">DAV NOIDA</span>
              <span className="footer-text22 footer-link">
        ...
        <div className="footer-copyright">
          <span className="footer-text25">
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className="footer-text29">@TeleportHQ.</span>
            </a>
            <span>
              <span>
                {' '}
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className="footer-text33">Vercel</span>
            </a>
            <span>
              <span>
                . Image source:
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className="footer-text37">Unsplash</span>
            </a>
            <span>.</span>
          </span>
        </div>
