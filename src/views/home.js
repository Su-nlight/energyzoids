    ...
    <div className="home-container">
      ...
      <main className="home-main">
        ...
        <div className="home-sponsors section-container">
          <div className="home-max-width2 max-content-container">
            ...
            <div className="home-container01">
              <img
                alt="image"
                src="/whatsapp%20image%202022-10-08%20at%201.49.04%20am%20%5B1%5D-200h.jpeg"
                loading="lazy"
                className="home-image1"
              />
              <img
                alt="image"
                src="/whatsapp%20image%202022-10-08%20at%201.49.03%20am%20%5B1%5D-200h.jpeg"
                loading="lazy"
                className="home-image2"
              />
              <img
                alt="image"
                src="/whatsapp%20image%202022-10-08%20at%201.49.04%20am-200h.jpeg"
                loading="lazy"
                className="home-image3"
              />
              <img
                alt="image"
                src="/whatsapp%20image%202022-10-08%20at%201.49.03%20am-200h.jpeg"
                loading="lazy"
                className="home-image4"
              />
              <img
                alt="image"
                src="/whatsapp%20image%202022-10-08%20at%201.49.02%20am-200h.jpeg"
                loading="lazy"
                className="home-image5"
              />
              <img
                alt="image"
                src="/whatsapp%20image%202022-10-08%20at%201.49.05%20am-200h.jpeg"
                loading="lazy"
            ...
            <div className="home-speakers-container">
              <Link to="/rohan">
                <SpeakerCard
                  ...
                  image_src="/speaker/d46da0c8-516b-4338-8dad-958f01f365e5%5B1-300h.jpeg"
                  firstName="Rohan"
                  lastName="Sahu"
                  role="Event Head"
              ...
              <Link to="/sumit">
                <SpeakerCard
                  ...
                  image_src="/speaker/1657d8c4-ffc7-49c7-86bd-1eed807e3f16-300w.jpeg"
                  firstName="Sumit"
                  lastName="Sharma"
              ...
              <Link to="/utkarsh">
                <SpeakerCard
                  ...
                  image_src="/speaker/6e9b8eab-cef0-4aec-9183-e17ea1c67c7a1-300w.jpeg"
              ...
              <Link to="/khushi">
                <SpeakerCard
                  ...
                  image_src="/speaker/9e2970ce-6d65-48bc-a267-0b82abb157db-300w.jpeg"
                  role="co-head @ student council"
                  firstName="Khushi"
                  lastName="Sharma"
              ...
              <Link to="/vedika">
                <SpeakerCard
                  rootClassName="speaker-card-root-class-name7"
                  image_src="/speaker/300026849_5527720317271509_3996587808719397565_n-300h.jpeg"
              ...
              <Link to="/siddhant">
                <SpeakerCard
                  rootClassName="speaker-card-root-class-name6"
                  image_src="/speaker/76774aac-d292-4a98-b378-63ff2fa20cca-300w.jpeg"
              ...
              <Link to="/diksha">
                <SpeakerCard
                  rootClassName="speaker-card-root-class-name5"
                  image_src="/speaker/1ce3e71f-97b2-4ac5-a28e-6cbec4cd731c-300w.jpeg"
                  role="TGT"
                  firstName="Diksha"
                  lastName="Gupta"
              ...
              <Link to="/pooja">
                <SpeakerCard
                  ...
                  image_src="/untitled%20design-300h.png"
                  role="TGT"
                  firstName="Pooja"
                  lastName="Khachi"
          ...
          <div className="home-container02 max-content-container">
            ...
            <div className="home-numbers-container">
              ...
              <NumbersCard
                text="speakers"
                number="11"
                image_src="/computer%20voice%20mail-200h.png"
              ></NumbersCard>
            </div>
          </div>
        </div>
            ...
            <div className="home-container03">
              ...
              <div className="home-container05">
                ...
                <span className="home-text27">
                  ...
                  making a good difference for the generations ahead. Also, here
                  we give you full opportunity to exhibit your knowledge to
                  students.
                </span>
        ...
        <div className="home-agenda section-container">
          ...
          >
            <div className="home-heading-container2">
              <h1 className="home-text28 Heading2">past events held</h1>
            ...
            <div className="home-events-container">
              <div className="home-column">
                ...
                <EventCard
                  ...
                  image_src="/whatsapp%20image%202022-10-07%20at%208.58.05%20pm%20%5B1%5D-200h.jpeg"
                ></EventCard>
                <EventCard
                  ...
                  image_src="/whatsapp%20image%202022-10-07%20at%208.58.05%20pm-200h.jpeg"
                ></EventCard>
                <EventCard
                  ...
                  image_src="/96ccbc7b-0166-4f7f-8832-5dc8efa7c4b7-200h.jpeg"
                ></EventCard>
                <EventCard
                  ...
                  image_src="/630edf7f-1909-40a1-85d1-0ef4adfb8d8d-200h.jpeg"
                ></EventCard>
              </div>
              <div className="home-column1">
                ...
                <EventCard
                  ...
                  title="a small step"
                  image_src="/5b02b027-6c2c-48f0-9a2a-7437004edc73-200h.jpeg"
                ></EventCard>
                <EventCard
                  text='An local extension to the whole India&apos;s "Clean India" programme. '
                  title="Swachh Bharat Abhiyan"
                  image_src="/4a0b488e-12cb-4494-95ef-294c85c06abe-200h.jpeg"
                ></EventCard>
                <EventCard
                  ...
                  title="Bio-Plastic"
                  image_src="/d00477c8-8dbd-486a-8232-ddd6ea3c8e8a-200w.jpeg"
                ></EventCard>
                <EventCard
                  text="Displays an important role in creating awareness among the people from all walks of life across the locality."
                  title="Street Plays"
                  image_src="/whatsapp%20image%202022-10-07%20at%208.58.05%20pm%20%5B2%5D-200h.jpeg"
                ></EventCard>
              </div>
            </div>
          </div>
        ...
        <div className="home-workshops">
          <div className="home-content-container2">
            <div className="home-container06">
              <h1 className="home-text30">
                ...
                <span className="Heading2">campaign </span>
                ...
                <span className="Heading2">programme</span>
                <br className="Heading2"></br>
              </h1>
          ...
          <img
            alt="image"
            src="/71918457-10c6-4b98-8846-f21d6ba28309-1500w.jpeg"
            loading="eager"
          ...
          <div className="home-bottom-container">
            <div className="home-left-side">
              ...
              <div className="home-social-media">
                <div className="home-social-media1">
                  <span className="home-text54">Follow Energy-zoids</span>
            ...
            <div className="home-links">
              <div className="home-container09">
                <span className="home-text55">quick navigation</span>
              ...
              <div className="home-container10">
                ...
                <a href="#speakers" className="home-link13 footer-link">
